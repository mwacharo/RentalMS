                                ...
                                <v-card-text>
                                    <v-container>
                                        <v-row>
                                            ...
                                            <v-col cols="12">
                                                <v-text-field v-model="editedItem.guard_name
                                                    " label=" Guard"></v-text-field>
                                            </v-col>
...
export default {
    ...
    methods: {
        ...
        deleteItemConfirm() {
            axios
                .delete(`/v1/permissions/${this.editedItem.id}`)
                .then(() => {
        ...
        save() {
            ...
            if (this.editedIndex > -1) {
                request = axios.put(
                    `/v1/permissions/${this.editedItem.id}`,
                    this.editedItem,
                ...
                request = axios.post(`/v1/permissions`, this.editedItem);
