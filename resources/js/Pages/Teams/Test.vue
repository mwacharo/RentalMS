        ...
        >
          <template v-slot:top>
            <v-toolbar flat>
              ...
              <v-spacer></v-spacer>
              <v-btn color="primary" dark class="mb-2" @click="openNewLandlordDialog">
                New Landlord
              </v-btn>
            </v-toolbar>
          </template>
        ...
        <v-card>
          ...
          <v-card-text>
            <v-container>
              <v-row>
                <v-col cols="12">
                  <v-text-field v-model="editedItem.landlord_name" label="Landlord Name"></v-text-field>
